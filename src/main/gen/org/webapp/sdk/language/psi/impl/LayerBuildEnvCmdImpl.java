...
public class LayerBuildEnvCmdImpl extends ASTWrapperPsiElement implements LayerBuildEnvCmd {

  public LayerBuildEnvCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitBuildEnvCmd(this);
  }
