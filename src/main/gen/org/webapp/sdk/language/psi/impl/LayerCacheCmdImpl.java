...
public class LayerCacheCmdImpl extends ASTWrapperPsiElement implements LayerCacheCmd {

  public LayerCacheCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitCacheCmd(this);
  }
