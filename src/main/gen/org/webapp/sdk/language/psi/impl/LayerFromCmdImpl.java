...
public class LayerFromCmdImpl extends ASTWrapperPsiElement implements LayerFromCmd {

  public LayerFromCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitFromCmd(this);
  }
