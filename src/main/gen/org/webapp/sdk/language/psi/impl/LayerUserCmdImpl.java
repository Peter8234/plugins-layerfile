...
public class LayerUserCmdImpl extends ASTWrapperPsiElement implements LayerUserCmd {

  public LayerUserCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitUserCmd(this);
  }
