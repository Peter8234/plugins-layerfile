...
public class LayerRunBackgroundCmdImpl extends ASTWrapperPsiElement implements LayerRunBackgroundCmd {

  public LayerRunBackgroundCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitRunBackgroundCmd(this);
  }
