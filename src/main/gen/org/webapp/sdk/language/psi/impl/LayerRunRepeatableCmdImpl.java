...
public class LayerRunRepeatableCmdImpl extends ASTWrapperPsiElement implements LayerRunRepeatableCmd {

  public LayerRunRepeatableCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitRunRepeatableCmd(this);
  }
