...
public class LayerCloneCmdImpl extends ASTWrapperPsiElement implements LayerCloneCmd {

  public LayerCloneCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitCloneCmd(this);
  }
