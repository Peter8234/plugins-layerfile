...
public class LayerMemoryCmdImpl extends ASTWrapperPsiElement implements LayerMemoryCmd {

  public LayerMemoryCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitMemoryCmd(this);
  }
