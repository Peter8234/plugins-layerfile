...
public class LayerSplitCmdImpl extends ASTWrapperPsiElement implements LayerSplitCmd {

  public LayerSplitCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitSplitCmd(this);
  }
