...
public class LayerWaitCmdImpl extends ASTWrapperPsiElement implements LayerWaitCmd {

  public LayerWaitCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitWaitCmd(this);
  }
