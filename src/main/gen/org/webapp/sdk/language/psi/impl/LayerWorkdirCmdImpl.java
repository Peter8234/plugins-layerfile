...
public class LayerWorkdirCmdImpl extends ASTWrapperPsiElement implements LayerWorkdirCmd {

  public LayerWorkdirCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitWorkdirCmd(this);
  }
