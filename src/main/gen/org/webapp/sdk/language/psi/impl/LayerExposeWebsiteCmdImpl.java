...
public class LayerExposeWebsiteCmdImpl extends ASTWrapperPsiElement implements LayerExposeWebsiteCmd {

  public LayerExposeWebsiteCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitExposeWebsiteCmd(this);
  }
