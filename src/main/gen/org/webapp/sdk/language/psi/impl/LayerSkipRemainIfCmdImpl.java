...
public class LayerSkipRemainIfCmdImpl extends ASTWrapperPsiElement implements LayerSkipRemainIfCmd {

  public LayerSkipRemainIfCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitSkipRemainIfCmd(this);
  }
