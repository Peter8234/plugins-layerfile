...
public class LayerSetupFileCmdImpl extends ASTWrapperPsiElement implements LayerSetupFileCmd {

  public LayerSetupFileCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitSetupFileCmd(this);
  }
