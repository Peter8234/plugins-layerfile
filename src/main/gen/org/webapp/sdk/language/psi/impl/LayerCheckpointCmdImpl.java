...
public class LayerCheckpointCmdImpl extends ASTWrapperPsiElement implements LayerCheckpointCmd {

  public LayerCheckpointCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitCheckpointCmd(this);
  }
