...
public class LayerButtonCmdImpl extends ASTWrapperPsiElement implements LayerButtonCmd {

  public LayerButtonCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitButtonCmd(this);
  }
