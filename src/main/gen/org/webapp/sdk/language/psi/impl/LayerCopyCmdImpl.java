...
public class LayerCopyCmdImpl extends ASTWrapperPsiElement implements LayerCopyCmd {

  public LayerCopyCmdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LayerVisitor visitor) {
    visitor.visitCopyCmd(this);
  }
